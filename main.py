...
from aiogram.types import ContentType, InputFile, FSInputFile
...
from Handlers import (check_user_account, get_user_model, get_user_send_model_name, set_user_model,
                      ...
                      set_user_only_ru, download_and_upload_file, reformat_text, photo_answer)
...
start_menu_keyboard = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboarяdButton(text="⚙️ Изменить модель", callback_data="Change_model")],
    ...
    if message.text and ("https://edu.skysmart.ru/student/" in message.text or
        ...
        try:
            ...
            for solution in answers:
                ...
                task_message_reformated = reformat_text(task_message)
                image = photo_answer(task_message_reformated)
                ...
                photo = FSInputFile(buf, filename="plot.png")
                try:
                    await message.answer_photo(photo=photo, caption=task_message)
